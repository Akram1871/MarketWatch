...
public class TCBDeptPL extends AppCompatActivity implements InsertData {
    ...
    public static TCBDeptPL INSTANCE;
    ...
    private void load() {
        ArrayAdapter<String> productName =new ArrayAdapter<String>(TCBDeptPL.this,android.R.layout.simple_spinner_item,
        ...
        ArrayAdapter<String> productCode =new ArrayAdapter<String>(TCBDeptPL.this,android.R.layout.simple_spinner_item,
