...
public class NBRDeptPL extends AppCompatActivity implements InsertData {
    ...
    public static NBRDeptPL INSTANCE;
    ...
    private void load() {
        ArrayAdapter<String> productName =new ArrayAdapter<String>(NBRDeptPL.this,android.R.layout.simple_spinner_item,
        ...
        ArrayAdapter<String> productCode =new ArrayAdapter<String>(NBRDeptPL.this,android.R.layout.simple_spinner_item,
