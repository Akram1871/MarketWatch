...
public class CCIEDeptPL extends AppCompatActivity implements InsertData {
    ...
    public static CCIEDeptPL INSTANCE;
    ...
    private void loadInfo() {
        ArrayAdapter<String> productName =new ArrayAdapter<String>(CCIEDeptPL.this,android.R.layout.simple_spinner_item,
        ...
        ArrayAdapter<String> productCode =new ArrayAdapter<String>(CCIEDeptPL.this,android.R.layout.simple_spinner_item,
